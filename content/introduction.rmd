...
There are other open source high-level scripting languages that are quite popular in research science, like [Python](http://www.python.org/) and [Perl](http://www.perl.org/).  These programming langauges offer features which are very similar to R.  The recent rise in popularity of R among the bioscience and data science communities has likely been driven by a few simple usability features that are unique to R.  In particular, the language has been designed from the ground up to make it easy to *interactively* explore large datasets and easily produce publication-quality visualizations.  
